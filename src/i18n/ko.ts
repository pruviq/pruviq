...
export const ko: Record<TranslationKey, string> = {
  ...
  "problem.card1_desc":
    "549개 이상의 코인에서 88개 전략 조합을 테스트했습니다. 2년 이상의 데이터에서 살아남은 건 단 1개. 선행 편향, 과적합, 레짐 무시 — 대부분의 전략이 같은 이유로 실패합니다.",
  "problem.card1_source": "출처: PRUVIQ 검증 파이프라인, 2024-2026",
  "problem.card2_title": "4개 전략 제거",
  "problem.card2_desc":
    "549개 이상의 코인, 2년 이상 데이터로 5개 전략을 테스트했습니다. 1개만 살아남았습니다. 나머지 4개는 손실을 기록했습니다. 대부분의 플랫폼은 실패를 보여주지 않습니다.",
  ...
  "evidence.step1_desc":
    "모든 전략은 549개 이상의 코인, 2년 이상의 데이터로 테스트한 후에만 실제 자본을 투입합니다. 예외 없음.",
  ...
  "evidence.step4_desc":
    "시장이 변하면 전략도 변해야 합니다. PRUVIQ는 지속적으로 테스트, 검증, 적응합니다. 오늘 돌아가는 것이 내일은 다를 수 있습니다 — 그게 핵심입니다.",
  ...
  "evidence.lesson3":
    "이 과정이 우리가 만드는 모든 것의 기반입니다. PRUVIQ의 모든 결정을 이끄는 하나의 원칙:",
  ...
  "system.step2": "시뮬레이션",
  "system.step2_desc":
    "549개 이상의 코인, 2년 이상의 데이터로 실행. 수수료, 슬리피지, 드로다운 포함. 빈틈 없이.",
  "system.step3": "검증",
  "system.step3_desc":
  ...
  "features.card2_desc":
    "549개 이상의 코인에서 5개 전략 백테스트. 검증된 것과 중단된 것 모두 결과 공개.",
  ...
  "how.step2": "백테스트",
  "how.step2_desc":
    "549개 이상 코인, 2년 이상 데이터로 실행. 수수료, 슬리피지 포함.",
  "how.step3": "검증",
  "how.step3_desc":
  ...
  "blog.desc":
    "무엇이 되고 안 되는지 확인하세요. 549개 코인, 88개 파라미터 조합에서 얻은 백테스팅 방법론, 리스크 관리, 교훈.",
  ...
  "demo.hero_desc":
    "아래 손절/익절 슬라이더를 조정하여 전략 성과가 어떻게 변하는지 확인하세요. 549개+ 코인에 대한 실제 백테스트 결과이며, 수수료가 포함되어 있습니다.",
  ...
  "coins.desc":
    "549개 이상 암호화폐의 실시간 시장 데이터. 가격, 시가총액, 거래량, 7일 차트 — 15분마다 갱신.",
  "coins.search": "코인 검색...",
  "coins.apply": "전략 적용",
  "coins.resim": "재시뮬레이션",
  "coins.trades": "거래 내역",
  ...
  "meta.coins_desc":
    "프루빅(PRUVIQ)의 실시간 암호화폐 시장 데이터. 549개 이상 코인의 가격, 시가총액, 거래량, 7일 차트를 확인하세요. 15분마다 갱신됩니다.",
  "meta.home_title":
    "PRUVIQ \u2014 무료 암호화폐 전략 백테스터 | 549+ 코인, 가입 불필요",
  "meta.home_desc":
    "549개 이상의 코인에서 2년+ 데이터로 무료 백테스트. 수수료, 슬리피지 모델링, 실패 포함 전체 결과 공개. 가입 불필요.",
  "meta.simulate_title":
    "전략 시뮬레이터 \u2014 커스텀 전략 빌드 & 백테스트 | PRUVIQ",
  "meta.simulate_desc":
    "11개+ 지표로 커스텀 전략을 만들고 549+ 코인에서 백테스트. 코딩 불필요. 무료, 즉시 결과.",
  "meta.index_desc":
    "프루빅(PRUVIQ) — 무료 크립토 전략 백테스팅. 549개 이상 코인과 2년 이상의 실제 데이터로 전략을 검증하고, 실패 사례까지 투명하게 공개합니다.",
  ...
  "meta.demo_desc":
    "PRUVIQ 전략 시뮬레이터를 즉시 체험하세요. 손절/익절을 조정하여 549개+ 코인에 대한 실제 백테스트 결과를 확인하세요.",
  ...
  "meta.performance_desc":
    "BB Squeeze SHORT 전략 백테스트 결과. 549개 코인, 2년 이상 데이터, 2,898건 거래. 실패 포함 전체 공개.",
  ...
  "about.philosophy3_desc":
    "모든 전략은 549개 이상의 코인에서 2년 이상의 데이터로 백테스트한 후 공개합니다. 근거 없이 권하지 않습니다.",
  ...
  "perf.desc":
    "BB Squeeze SHORT 전략 백테스트 결과. 549개 코인, 2년 이상 과거 데이터. 체리피킹 없음.",
  ...
  "perf.results_desc":
    "2년+, 549개 코인, 2,898건 거래. 0.08%/side 수수료 포함.",
  ...
  "blog.cta_desc":
    "549개 코인, 2년 이상의 데이터로 트레이딩 전략을 시뮬레이션하세요. 무료.",
  ...
  "meta.builder_desc":
    "코드 없이 나만의 트레이딩 전략을 설계하세요. 지표 선택, 조건 설정, 549+ 코인 2년+ 실제 데이터로 백테스트.",
  ...
  "learn.cta_desc":
    "전략을 만들고 549개 이상의 코인에서 실행하세요 — 무료, 계정 불필요.",
  ...
  "simulate.step3_title": "549개+ 코인에서 백테스트 실행",
  ...
  "methodology.cta_desc":
    "파라미터를 조정하고 549개+ 코인에 대한 실제 백테스트 결과를 확인하세요.",
  ...
  "meta.api_desc":
    "무료 크립토 전략 백테스팅 REST API. 549개 이상 코인에서 전략 시뮬레이션, OHLCV 데이터, 시장 개요 등을 제공합니다.",
  "api.tag": "API 레퍼런스",
  ...
  "meta.vs_tv_desc":
    "크립토 전략 백테스팅에서 PRUVIQ와 트레이딩뷰를 비교합니다. Pine Script 불필요. 영원히 무료. 549개+ 코인. 완전 백테스트 투명성.",
  "vs.tag": "솔직한 비교",
  ...
  "faq.a1":
    "PRUVIQ는 무료 크립토 전략 백테스팅 플랫폼입니다. 11개 이상의 기술 지표를 사용해 커스텀 전략을 만들고, 549개 이상의 코인에서 2년 이상의 실제 시장 데이터로 백테스트하며, 수수료와 슬리피지를 포함한 현실적인 결과를 확인할 수 있습니다. 코딩 불필요.",
  ...
  "faq.a3":
    "네, PRUVIQ의 핵심 백테스팅 기능은 완전 무료입니다. 전략 만들기, 549개 이상 코인 백테스트, 모든 교육 콘텐츠 이용이 결제나 계정 생성 없이 가능합니다.",
  "faq.q4": "PRUVIQ가 TradingView 등 다른 도구와 다른 점은?",
  "faq.a4":
    "PRUVIQ는 코딩 없이 크립토 선물에 특화되어 설계되었습니다. TradingView(Pine Script 필요)나 QuantConnect(Python/C# 필요)와 달리 시각적 전략 빌더를 제공합니다. 또한 실패를 포함한 실제 거래 결과를 공개하고, 549개 이상 코인을 동시에 테스트하며, 모든 시뮬레이션에 현실적인 수수료와 슬리피지를 포함합니다.",
  "faq.q5": "PRUVIQ는 전략을 어떻게 검증하나요?",
  "faq.a5":
    "PRUVIQ는 549개 이상의 코인에서 2년 이상의 과거 데이터로 모든 전략을 백테스트합니다. 수수료, 슬리피지, 펀딩비를 포함한 현실적인 시뮬레이션으로 검증하며, 실패한 전략도 모두 공개합니다.",
  ...
  "leaderboard.desc":
    "549개 이상의 코인에서 이번 주 가장 좋은 성과를 보인 전략 설정을 확인하세요. 매주 월요일 업데이트.",
  ...
  "coin_detail.strategy_desc":
    "BB Squeeze 전략은 {name}에서 저변동성 구간(볼린저밴드 압축)을 식별합니다. 밴드가 확장되고 가격이 하향 돌파하면 숏 포지션에 진입합니다. 549개 코인에서 Out-of-Sample 테스트와 몬테카를로 시뮬레이션으로 검증되었습니다.",
  ...
  "vs_3commas.row_price_p": "영구 무료",
  "vs_3commas.row_price_other": "$22–37/월 (Starter–Advanced)",
  ...
  "vs_3commas.row_multi_p": "549개 코인 동시 테스트",
  "vs_3commas.row_multi_other": "봇 단위 설정, 배치 백테스트 불가",
  "vs_3commas.row_live": "실거래",
  "vs_3commas.row_live_p": "연구 도구 — 백테스트 전용",
  "vs_3commas.row_live_other": "가능 — DCA·그리드 봇",
  "vs_3commas.row_builder": "전략 빌더",
  "vs_3commas.row_builder_p": "시각적 지표 빌더",
  "vs_3commas.row_builder_other": "DCA/그리드 봇 설정",
  "vs_3commas.row_api": "API 접근",
  "vs_3commas.row_api_p": "오픈 REST API",
  "vs_3commas.row_api_other": "유료 플랜에서 제공",
  "vs_3commas.row_community": "커뮤니티",
  "vs_3commas.row_community_p": "공개 랭킹 & 리더보드",
  ...
  "vs_coinrule.row_coins_p": "549개 코인 (바이낸스 선물)",
  ...
  "vs_coinrule.row_multi_p": "549개 코인 동시 테스트",
  ...
  "vs_cryptohopper.row_price_p": "영구 무료",
  "vs_cryptohopper.row_price_other": "$19–107/월 (Pioneer–Hero)",
  ...
  "vs_cryptohopper.row_coins_p": "549개 코인 (바이낸스 선물)",
  ...
  "vs_cryptohopper.row_multi_p": "549개 코인 동시 테스트",
  "vs_cryptohopper.row_multi_other": "봇별 설정, 배치 백테스트 불가",
  "vs_cryptohopper.row_live": "실거래",
  "vs_cryptohopper.row_live_p": "연구 도구 — 백테스트 전용",
  "vs_cryptohopper.row_live_other": "가능 — 클라우드 봇 24/7 운영",
  "vs_cryptohopper.row_builder": "전략 빌더",
  "vs_cryptohopper.row_builder_p": "시각적 지표 빌더",
  "vs_cryptohopper.row_builder_other": "템플릿 디자이너 및 마켓플레이스 전략",
  "vs_cryptohopper.row_api": "API 접근",
  "vs_cryptohopper.row_api_p": "오픈 REST API",
  "vs_cryptohopper.row_api_other": "유료 플랜에서 제공",
  ...
  "vs_gainium.row_coins_p": "549개 코인 (바이낸스 선물)",
  ...
  "vs_gainium.row_multi_p": "549개 코인 동시 테스트",
  ...
  "vs_streak.row_coins_p": "549개 코인 (바이낸스 선물)",
  ...
  "vs_streak.row_multi_p": "549개 코인 동시 테스트",
  ...
  "vs_streak.when_pruviq_2": "549개 코인에 전략을 동시에 테스트하고 싶을 때",
