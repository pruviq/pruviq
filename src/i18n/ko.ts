...
export const ko: Record<TranslationKey, string> = {
  ...
  'about.founder_tag': '설립자',
  'about.founder_name': 'JPLee',
  'about.founder_role': '퀀트 개발자 & 트레이더',
  'about.founder_bio': 'JPLee는 직감이 아닌 코드로 트레이딩하는 엔지니어입니다. 인플루언서 시그널을 따라가다 돈을 잃은 후, 실거래 전에 데이터로 전략을 증명하는 PRUVIQ를 만들었습니다. 모든 전략을 본인의 자금으로 먼저 운영합니다.',
  'about.founder_stat1_label': '테스트한 전략',
  'about.founder_stat1_val': '5개+',
  'about.founder_stat2_label': '시뮬레이션 코인',
  'about.founder_stat2_val': '535개',
  'about.founder_stat3_label': '분석한 거래',
  'about.founder_stat3_val': '2,898건+',
