...
export const ko: Record<TranslationKey, string> = {
  ...
  'problem.card1_desc': '549개 코인에서 88개 전략 조합을 테스트했습니다. 2년 이상의 데이터에서 살아남은 건 단 1개. 선행 편향, 과적합, 레짐 무시 — 대부분의 전략이 같은 이유로 실패합니다.',
  'problem.card1_source': '출처: PRUVIQ 검증 파이프라인, 2024-2026',
  'problem.card2_title': '4개 전략 제거',
  'problem.card2_desc': '549개 코인, 2년 이상 데이터로 5개 전략을 테스트했습니다. 1개만 살아남았습니다. 나머지 4개는 손실. 대부분의 플랫폼은 실패를 보여주지 않습니다.',
  ...
  'evidence.lesson1': '5개 전략 유형, 88개 파라미터 조합을 549개 코인에서 2년 이상의 데이터로 테스트했습니다.',
  ...
  'features.card2_desc': '549개 코인에서 5개 전략 백테스트. 검증된 것과 중단된 것 모두 결과 공개.',
  ...
  'methodology.metrics_coming': '고급 지표(샤프, 소르티노, 칼마 비율)는 모든 시뮬레이션에서 계산되며, 향후 업데이트에서 전략 상세 페이지에 표시될 예정입니다.',
