...
export const ko: Record<TranslationKey, string> = {
  ...
  'meta.home_desc': '535개 이상 코인에서 2년 이상 실제 데이터를 사용해 트레이딩 전략을 만들고 백테스트하세요. 코드 불필요; 현실적인 수수료와 슬리피지 반영. 영원히 무료.',
  'meta.index_desc': '무료 크립토 전략 백테스팅 — 535개 이상 코인에서 2년 이상의 실제 데이터와 현실적인 수수료로 전략을 테스트하세요. 검증된 결과와 실패 사례까지 모두 공개합니다.',
