...
**왜 대부분의 백테스트가 거짓인가**: 백테스트와 실거래 사이의 격차는 엄청납니다. 우리의 Momentum LONG 전략은 백테스트에서 +400%였지만 실거래에서 $14,115를 잃었습니다. 차이점? 실제 돈으로 거래할 때만 드러나는 버그입니다.
...
balance = 3000  # 시작 자본
for trade in trades:
    position_size = min(60, balance * 0.02)  # $60 또는 잔액의 2%
...
**우리의 검증된 전략 (BB Squeeze SHORT)**: 승률 70.4%, 수익 팩터 2.55, 535개 코인에서 2,898건 거래. 이 수치는 2024, 2025, 2026 데이터에서 아웃오브샘플 검증을 통과했습니다.
