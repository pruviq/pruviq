...
export const ko: Record<TranslationKey, string> = {
  ...
  'evidence.lesson_tag': '88개 전략 테스트',
  ...
  'blog.desc': '무엇이 되고 안 되는지 확인하세요. 549개 코인, 88개 전략 조합에서 얻은 백테스팅 방법론, 리스크 관리, 교훈.',
  ...
  'perf.desc': '실거래 계좌의 실제 결과. BB Squeeze SHORT 전략, 549개 코인. 매일 업데이트. 체리피킹 없음.',
  ...
  'meta.vs_tv_desc': '크립토 전략 백테스팅에서 PRUVIQ와 트레이딩뷰를 비교합니다. Pine Script 불필요. 영원히 무료. 549개+ 코인. 실거래 검증 포함.',
  'vs.tag': '솔직한 비교',
  ...
  'vs.tldr': '요약',
  'vs.tldr_text': '차트와 커뮤니티는 트레이딩뷰. 무료 노코드 크립토 백테스팅과 실거래 검증은 PRUVIQ.',
  'vs.feature': '기능',
  'vs.pruviq': 'PRUVIQ',
