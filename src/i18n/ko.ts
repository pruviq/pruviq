...
export const ko: Record<TranslationKey, string> = {
  ...
  'meta.home_desc': '535개 이상의 코인과 2년 이상의 실제 데이터를 기반으로 하는 무료 전략 백테스팅. 현실적인 수수료와 슬리피지를 반영하며, 검증된 결과(승패)를 공개하여 거래 전에 확인할 수 있습니다.',
  'meta.index_desc': '프루빅(PRUVIQ) — 무료 크립토 전략 백테스팅. 535개 이상 코인과 2년 이상의 실제 데이터로 전략을 검증하고, 실패 사례까지 투명하게 공개합니다.',
  ...
  'meta.api_desc': '무료 크립토 전략 백테스팅 REST API. 535개 이상 코인에서 전략 시뮬레이션, OHLCV 데이터, 시장 개요 등을 제공합니다.',
  'api.tag': 'API 레퍼런스',
  ...
  'meta.vs_tv_desc': '크립토 전략 백테스팅에서 PRUVIQ와 트레이딩뷰를 비교합니다. Pine Script 불필요. 영원히 무료. 535개+ 코인. 실거래 검증 포함.',
  'vs.tag': '솔직한 비교',
  ...
  'vs.row_coins': '크립토 코인',
  'vs.row_coins_p': '535개+ USDT 무기한 선물',
  ...
  'vs.row_multi_p': '535개 코인 원클릭 테스트',
  ...
  'vs.when_pruviq_2': '535개+ 코인에서 동시 전략 테스트',
