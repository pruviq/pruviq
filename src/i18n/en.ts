export const en = {
  ...
  'hero.subtitle': 'Crypto backtesting for quant & algorithmic traders.',
  'hero.desc': 'Build trading strategies with no code. Backtest on 535+ coins with 2+ years of real data. Fees and slippage included. Free forever.',
