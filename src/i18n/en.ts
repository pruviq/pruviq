export const en = {
  ...
  'hero.desc': 'We tested 5 strategies on 500+ coins. 4 lost money. We published them all. Because you deserve to know what actually works before risking real money.',
  ...
  'problem.card1_desc': 'We tested 88 strategy combinations on 500+ coins. Only 1 survived 2+ years of data. Look-ahead bias, overfitting, regime blindness — most strategies fail for the same reasons.',
  'problem.card1_source': 'Source: PRUVIQ validation pipeline, 2024-2026',
  'problem.card2_title': '4 Strategies Killed',
  'problem.card2_desc': 'We tested 5 strategies on 500+ coins over 2+ years. Only 1 survived. The other 4 lost money. Most platforms never show you the failures.',
  ...
  'features.card2_desc': '5 strategies backtested on 500+ coins. Full results published — verified and killed alike.',
  ...
  'faq.a3': 'Yes, PRUVIQ\'s core backtesting features are completely free. You can build strategies, run backtests on 500+ coins, and access all education content without any payment or account creation.',
  'faq.q4': 'What makes PRUVIQ different from TradingView or other backtesting tools?',
  'faq.a4': 'PRUVIQ is specifically built for crypto futures with no coding required. Unlike TradingView (requires Pine Script) or QuantConnect (requires Python/C#), PRUVIQ offers a visual strategy builder. It also publishes real trading results including failures, tests on 500+ coins simultaneously, and includes realistic fees and slippage in all simulations.',
  'faq.q5': 'How does PRUVIQ verify strategies?',
  'faq.a5': 'PRUVIQ backtests all strategies on 500+ coins with 2+ years of historical data. Every simulation includes realistic fees, slippage, and funding costs. Failed strategies are published alongside successful ones for full transparency.',
} as const;
