...
export const ko: Record<TranslationKey, string> = {
  ...
  'hero.desc': '549개 이상의 코인에서 5개의 전략을 테스트했습니다. 4개는 손실을 기록했습니다. 모든 결과를 공개합니다. 실제 자금을 투입하기 전에 무엇이 실제로 작동하는지 확인하세요.',
  ...
  'problem.card1_desc': '549개 이상의 코인에서 88개 전략 조합을 테스트했습니다. 2년 이상의 데이터에서 살아남은 건 단 1개. 선행 편향, 과적합, 레짐 무시 — 대부분의 전략이 같은 이유로 실패합니다.',
  'problem.card1_source': '출처: PRUVIQ 검증 파이프라인, 2024-2026',
  'problem.card2_title': '4개 전략 제거',
  'problem.card2_desc': '549개 이상의 코인, 2년 이상 데이터로 5개 전략을 테스트했습니다. 1개만 살아남았습니다. 나머지 4개는 손실을 기록했습니다. 대부분의 플랫폼은 실패를 보여주지 않습니다.',
  ...
  'system.step2': '시뮬레이션',
  'system.step2_desc': '549개 이상의 코인, 2년 이상의 데이터로 실행. 수수료, 슬리피지, 드로다운 포함. 빈틈 없이.',
  'system.step3': '검증',
  ...
  'features.card2_desc': '549개 이상의 코인에서 5개 전략 백테스트. 검증된 것과 중단된 것 모두 결과 공개.',
  ...
  'strategies.verified_explanation': '검증됨 = 549개+ 코인, 2년+ 데이터에서 모든 검증 통과',
  ...
  'demo.hero_desc': '아래 손절/익절 슬라이더를 조정하여 전략 성과가 어떻게 변하는지 확인하세요. 549개+ 코인에 대한 실제 백테스트 결과이며, 수수료가 포함되어 있습니다.',
  'demo.want_more': '더 세밀한 제어가 필요하신가요?',
  'demo.want_more_desc': '전체 시뮬레이터에서는 20개+ 지표로 커스텀 전략을 만들고, 원하는 코인을 선택하여 테스트하고, OOS 검증까지 할 수 있습니다.',
  ...
  'coins.desc': '549개 이상 암호화폐의 실시간 시장 데이터. 가격, 시가총액, 거래량, 7일 차트 — 15분마다 갱신.',
  'coins.search': '코인 검색...',
  'coins.apply': '전략 적용',
  'coins.resim': '재시뮬레이션',
  'coins.trades': '거래 내역',
  ...
  'meta.demo_desc': 'PRUVIQ 전략 시뮬레이터를 즉시 체험하세요. 손절/익절을 조정하여 549개+ 코인에 대한 실제 백테스트 결과를 확인하세요.',
  ...
  'perf.results_desc': '2년+, 549개 코인, 2,898건 거래. 0.08%/side 수수료 포함.',
  'perf.killed_title': '기각된 전략',
  'perf.killed_desc': '테스트 후 기각한 전략들입니다. 실패도 성공만큼 중요하기에 공개합니다.',
  'perf.verify_title': '직접 확인하세요',
  'perf.verify_desc': '저희를 믿지 마세요. 시뮬레이터에서 SL/TP를 조정하여 결과가 실시간으로 변하는 것을 직접 확인하세요.',
  ...
  'perf.killed_bb_long': 'SHORT 전략을 LONG에 그대로 적용. 암호화폐 시장의 구조적 비대칭으로 실패.',
  'perf.killed_bb_long_result': '승률 31.4% \u00b7 PF 0.41 \u00b7 -$2,847',
  'perf.killed_momentum': '20봉 고점 돌파 + 거래량 확인. 모든 시장 상황에서 치명적 손실.',
  'perf.killed_momentum_result': '승률 28.1% \u00b7 PF 0.35 \u00b7 -$4,102',
  'perf.killed_all_long': '88개 LONG 전략 조합을 전체 지표로 테스트. OOS 검증을 통과한 전략 없음.',
  'perf.killed_all_long_result': '0/88 생존 \u00b7 평균 PF 0.67',
  'perf.killed_btc_regime': 'BTC 추세에 따라 거래 필터링. 위험 조정 수익률 개선 없이 복잡성만 증가.',
  ...
  'simulate.risk_disclaimer': '시뮬레이션 전용 \u2014 실거래가 아닙니다. 과거 성과가 미래 수익을 보장하지 않습니다. 선물 거래는 손실 위험이 있습니다.',
  ...
  'methodology.universe_desc': '바이낸스에 상장된 549개 이상의 USDT 무기한 선물 페어. 상장 폐지된 코인과 유동성이 낮은 페어는 제외됩니다. 정확한 수는 전략 버전에 따라 다릅니다.',
  ...
  'methodology.cta_desc': '파라미터를 조정하고 549개+ 코인에 대한 실제 백테스트 결과를 확인하세요.',
  ...
  'methodology.term_oos': 'Out-of-Sample(표본 외 검증) = 전략이 한 번도 보지 못한 데이터로 테스트하여, 실제로 작동하는지 패턴만 외웠는지 확인합니다.',
  'methodology.term_mc': '몬테카를로 = 1,000회 이상 무작위 시뮬레이션으로 최악 시나리오와 신뢰 수준을 확인합니다.',
  ...
  'faq.a3': '네, PRUVIQ의 핵심 백테스팅 기능은 완전 무료입니다. 전략 만들기, 549개 이상 코인 백테스트, 모든 교육 콘텐츠 이용이 결제나 계정 생성 없이 가능합니다.',
  'faq.q4': 'PRUVIQ가 TradingView 등 다른 도구와 다른 점은?',
  'faq.a4': 'PRUVIQ는 코딩 없이 크립토 선물에 특화되어 설계되었습니다. TradingView(Pine Script 필요)나 QuantConnect(Python/C# 필요)와 달리 시각적 전략 빌더를 제공합니다. 또한 실패를 포함한 실제 거래 결과를 공개하고, 549개 이상 코인을 동시에 테스트하며, 모든 시뮬레이션에 현실적인 수수료와 슬리피지를 포함합니다.',
  'faq.q5': 'PRUVIQ는 전략을 어떻게 검증하나요?',
  'faq.a5': 'PRUVIQ는 549개 이상의 코인에서 2년 이상의 과거 데이터로 모든 전략을 백테스트합니다. 수수료, 슬리피지, 펀딩비를 포함한 현실적인 시뮬레이션으로 검증하며, 실패한 전략도 모두 공개합니다.',

  // Tooltips
  'tooltip.sl': '손절(Stop Loss) \u2014 자동 종료 전 최대 손실. 예: 10% = 가격이 10% 불리하게 움직이면 포지션 종료.',
  'tooltip.tp': '익절(Take Profit) \u2014 자동 종료 수익 목표. 예: 8% = 가격이 8% 유리하게 움직이면 포지션 종료.',
  'tooltip.sharpe': '샤프 비율 \u2014 위험 대비 수익. 1.0 이상 양호, 2.0 이상 우수.',
  'tooltip.sortino': '소르티노 비율 \u2014 샤프와 유사하나 하방 위험만 고려. 큰 수익이 가끔 나는 전략에 더 정직한 지표.',
  'tooltip.calmar': '칼마 비율 \u2014 수익률 \u00f7 최대 낙폭. 높을수록 손실에서 빠르게 회복.',
  'tooltip.pf': '수익 팩터 \u2014 총 수익 \u00f7 총 손실. 1.5 이상 강함, 2.0 이상 우수.',
  'tooltip.mdd': '최대 낙폭(MDD) \u2014 고점 대비 최대 하락. 낮을수록 좋음.',
  'tooltip.wr': '승률 \u2014 수익 거래 비율. 좋은 손익비와 함께 50% 이상이면 견고.',
  'tooltip.oos': 'Out-of-Sample \u2014 과적합 방지를 위해 보지 못한 데이터로 테스트.',
  'tooltip.mc': '몬테카를로 \u2014 1,000회+ 무작위 시뮬레이션으로 전략 견고성 확인.',
